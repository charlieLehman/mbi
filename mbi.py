...
tf.app.flags.DEFINE_string('data_dir', '/home/charlie/mbi_experiment/cifar10_data',
                           """Path to the CIFAR-10 data directory.""")
tf.app.flags.DEFINE_boolean('use_fp16', False,
                            """Train the model using fp16.""")

# Global constants describing the CIFAR-10 data set.
IMAGE_SIZE = mbi_input.IMAGE_SIZE
NUM_CLASSES = mbi_input.NUM_CLASSES
NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN = mbi_input.NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN
NUM_EXAMPLES_PER_EPOCH_FOR_EVAL = mbi_input.NUM_EXAMPLES_PER_EPOCH_FOR_EVAL
